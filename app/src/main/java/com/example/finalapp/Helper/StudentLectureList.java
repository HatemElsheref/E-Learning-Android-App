...
public class StudentLectureList  extends BaseAdapter implements ListAdapter {
    ...
    public StudentLectureList(ArrayList<Lecture> list, Context context,String token) {
        this.list = list;
...
//        return  list.get(pos).getById();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.component_student_lecture_list_buttons, null);
        }

        //Handle TextView and display string from your list
        TextView listItemText = (TextView)view.findViewById(R.id.student_lectures_item_string);
        listItemText.setText(list.get(position).name);
        //Handle buttons and add onClickListeners

        ImageView downloadBtn = (ImageView)view.findViewById(R.id.download_student_lecture);
